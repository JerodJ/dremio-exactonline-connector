...
@SourceType(value = "ExactOnlineARP", label = "ExactOnline",uiConfig = "exactonline-layout.json")
public class ExactOnlineConf extends AbstractArpConf<ExactOnlineConf> {
  private static final String ARP_FILENAME = "arp/implementation/exactonline-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.exactonline.ExactOnlineDriver";
